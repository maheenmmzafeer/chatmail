  ...
  return (
    <PublicTheme>
      <div className="relative flex min-h-screen items-center justify-center overflow-hidden px-4 py-10">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(95,119,255,0.1),transparent_50%)]" />
        <div className="pointer-events-none absolute left-1/2 top-1/2 h-[560px] w-[560px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[rgba(95,119,255,0.12)] blur-[140px]" />

        <div className="relative w-full max-w-md rounded-[28px] border border-[var(--border)] bg-[var(--bg-panel)] p-8 shadow-[var(--shadow-md)] backdrop-blur-2xl sm:p-10">
          <div className="mb-8 flex flex-col items-center text-center">
            <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-[var(--accent)] shadow-[var(--shadow-glow)]">
          ...
          {error ? (
            <div className="mb-5 w-full rounded-2xl border border-red-500/25 bg-red-500/8 px-4 py-3 text-center text-sm leading-relaxed text-red-700">
          ...
          <p className="mt-6 text-center text-xs leading-relaxed text-[var(--text-muted)]">
            By continuing, you agree to ChatMail&apos;s Terms of Service and Privacy Policy. We only access your email to display it in a conversational format.
          </p>
        </div>
      </div>
    </PublicTheme>
